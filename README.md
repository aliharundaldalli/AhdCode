...
- [PostgreSQL module](docs/POSTGRESQL.md)
- [HTTP module](docs/HTTP.md)
- [WebSocket endpoints](docs/WEBSOCKET.md)
...
- [v2.2 student performance](examples/v2.2/student_performance/README.md) — one desktop application that shows the same grades as a line, bar, histogram, box, error bar, pie, heatmap, and 3D surface
- [v2.3 examples](examples/v2.3/README.md) — explicit named-Function `uses` captures and Plot/Surface mathematical labels
- [v2.4 examples](examples/v2.4/README.md) — embedded Tectonic math glyphs, plot styling, legend positions, and Surface labels
...
See the [v2.4 examples](examples/v2.4/README.md),
[Plot](docs/PLOT.md), and [Installation](docs/INSTALLATION.md) references.
...
See the [v2.3 examples](examples/v2.3/README.md),
[Functions](docs/FUNCTIONS.md), [LSP](docs/LSP.md), and
[Plot](docs/PLOT.md) references.
...
- [`Plot.pie(labels, values)`](docs/PLOT.md#pie): one slice per category, in
...
- [`Plot.heatmap(xLabels, yLabels, values)`](docs/PLOT.md#heatmap): a
...
- [`Surface.xCategories` and `Surface.yCategories`](docs/PLOT.md#naming-the-coordinates):
...
See the [v2.2 example](examples/v2.2/student_performance/README.md).
...
- [`GUI`](docs/GUI.md): ListBox, Select, TextArea, PasswordInput, and a
...
- [`Plot`](docs/PLOT.md): the viewer gains a toolbar — Save (PNG, SVG, PDF,
  ...
  PNG export.
- [`ahdcode package`](docs/PACKAGING.md) turns a program into a desktop
...
See the [v2.0 examples](examples/v2.0/README.md).
...
- [`GUI`](docs/GUI.md): a new standard module for small desktop windows with a
...
- [`Graphics`](docs/GRAPHICS.md): `Canvas.onClick` and `Canvas.onKey` run a
...
See the [v1.8 examples](examples/v1.8/README.md).
...
[v1.7 examples](examples/v1.7/README.md).
...
**New standard module: [`Graphics`](docs/GRAPHICS.md)** — visual programming
and 2D drawing:
...
[Graphics and Turtle examples](examples/v1.6/graphics_turtle/README.md).
...
**New standard module: [`UUID`](docs/UUID.md)** — `UUID.v4()` and the
...
**New standard module: [`PostgreSQL`](docs/POSTGRESQL.md)** — `connect`,
...
**WebSocket endpoints in [`HTTP`](docs/WEBSOCKET.md)** — `HTTP.websocket`,
...
**Extended module: [`Env`](docs/ENV.md#secret)** — `Env.secret(name)` reads
...
[`examples/v0.1/69_uuid.ahd`](examples/v0.1/69_uuid.ahd) through
[`examples/v0.1/72_websocket_echo.ahd`](examples/v0.1/72_websocket_echo.ahd)
and the [realtime attendance application](examples/v1.4/realtime_attendance/README.md).
