...
Response values, cookies, and in-memory server-side sessions; HTML is a small safe structured builder; Env reads process/`.env` configuration; Lists and KeyValue are the pure
