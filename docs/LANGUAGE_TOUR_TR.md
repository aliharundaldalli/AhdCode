...
HTTP yerel bir web sunucusudur (çerez, bellek içi oturumlar ve giden HTTP/HTTPS Client ile), HTML küçük güvenli bir HTML oluşturucusu artı bir ayrıştırıcı ve CSS benzeri seçici sorgu yüzeyidir (`HTML.parse`, `HTMLDocument`, `HTMLElement`),
