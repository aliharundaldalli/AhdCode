...
the [v0.17 routes and guards example](../examples/v0.17/routes_guards), the
[v0.18 Web starters](../examples/v0.18/README.md), and the
[v1.4 realtime attendance application](../examples/v1.4/realtime_attendance/README.md)
...
[`examples/v1.5/terminal_demo`](../examples/v1.5/terminal_demo/README.md).
