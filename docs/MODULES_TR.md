...
`Math`, `Time`, `Latex`, `Word`, `Path`, `File`, `Regex`, `CSV`, `Data`, `Statistics`, `Plot` ve `Numeric` derleyici tarafından
...
[CSV](CSV_TR.md), [Data](DATA_TR.md), [Statistics](STATISTICS_TR.md), [Plot](PLOT_TR.md), [Numeric](NUMERIC_TR.md), [Word](WORD_TR.md) ve diğer modül referanslarına bakın.
