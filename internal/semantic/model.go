...
const (
	...
	PDFDocumentLayout      TypeOperation = "PDFDocument.layout"
	PDFDocumentHeader      TypeOperation = "PDFDocument.header"
	PDFDocumentFooter      TypeOperation = "PDFDocument.footer"
	PDFDocumentPageNumbers TypeOperation = "PDFDocument.pageNumbers"
	PDFDocumentQR          TypeOperation = "PDFDocument.qr"
	PDFDocumentBarcode     TypeOperation = "PDFDocument.barcode"
	PDFDocumentLink        TypeOperation = "PDFDocument.link"
	PDFDocumentBookmark    TypeOperation = "PDFDocument.bookmark"
	PDFDocumentMetadata    TypeOperation = "PDFDocument.metadata"
	...
	ExcelWorkbookSheets     TypeOperation = "Workbook.sheets"
	ExcelWorkbookSheetCount TypeOperation = "Workbook.sheetCount"
	ExcelWorkbookSave       TypeOperation = "Workbook.save"
	ExcelSheetName          TypeOperation = "Sheet.name"
	ExcelSheetCell          TypeOperation = "Sheet.cell"
	ExcelSheetSetCell       TypeOperation = "Sheet.setCell"
	ExcelSheetRange         TypeOperation = "Sheet.range"
	ExcelSheetSetRow        TypeOperation = "Sheet.setRow"
	ExcelSheetSetRange      TypeOperation = "Sheet.setRange"
	ExcelSheetCells         TypeOperation = "Sheet.cells"
	ExcelSheetUsedRange     TypeOperation = "Sheet.usedRange"
	ExcelSheetMerge         TypeOperation = "Sheet.merge"
	ExcelSheetMerges        TypeOperation = "Sheet.merges"
	ExcelSheetStyle         TypeOperation = "Sheet.style"
	ExcelSheetColumnWidth   TypeOperation = "Sheet.columnWidth"
	ExcelSheetRowHeight     TypeOperation = "Sheet.rowHeight"
	ExcelCellKind           TypeOperation = "Cell.kind"
	ExcelCellIsBlank        TypeOperation = "Cell.isBlank"
	ExcelCellString         TypeOperation = "Cell.string"
	ExcelCellInt            TypeOperation = "Cell.int"
	ExcelCellReal           TypeOperation = "Cell.real"
	ExcelCellBool           TypeOperation = "Cell.bool"
	ExcelCellFormula        TypeOperation = "Cell.formula"
	ExcelRangeStartRow      TypeOperation = "Range.startRow"
	ExcelRangeStartColumn   TypeOperation = "Range.startColumn"
	ExcelRangeEndRow        TypeOperation = "Range.endRow"
	ExcelRangeEndColumn     TypeOperation = "Range.endColumn"
	ExcelRangeRowCount      TypeOperation = "Range.rowCount"
	ExcelRangeColumnCount   TypeOperation = "Range.columnCount"
	ExcelRangeAddress       TypeOperation = "Range.address"
	ExcelStyleBold          TypeOperation = "CellStyle.bold"
	ExcelStyleItalic        TypeOperation = "CellStyle.italic"
	ExcelStyleUnderline     TypeOperation = "CellStyle.underline"
	ExcelStyleFontSize      TypeOperation = "CellStyle.fontSize"
	ExcelStyleTextColor     TypeOperation = "CellStyle.textColor"
	ExcelStyleFillColor     TypeOperation = "CellStyle.fillColor"
	ExcelStyleHorizontal    TypeOperation = "CellStyle.horizontal"
	ExcelStyleVertical      TypeOperation = "CellStyle.vertical"
	ExcelStyleWrap          TypeOperation = "CellStyle.wrap"
	ExcelStyleNumberFormat  TypeOperation = "CellStyle.numberFormat"
	ExcelStyleBorder        TypeOperation = "CellStyle.border"
	...
	HTTPServerManaged           TypeOperation = "Server.managed"
	HTTPServerApplyWebLimits    TypeOperation = "Server.applyWebLimits"
	...
	HTTPClientSend              TypeOperation = "Client.send"
	HTTPClientGet               TypeOperation = "Client.get"
	HTTPClientPost              TypeOperation = "Client.post"
	HTTPClientRequestWithHeader TypeOperation = "ClientRequest.withHeader"
	HTTPClientRequestAddHeader  TypeOperation = "ClientRequest.addHeader"
	HTTPClientRequestWithBody   TypeOperation = "ClientRequest.withBody"
	HTTPClientResponseStatus    TypeOperation = "ClientResponse.status"
	HTTPClientResponseBody      TypeOperation = "ClientResponse.body"
	HTTPClientResponseHeader    TypeOperation = "ClientResponse.header"
