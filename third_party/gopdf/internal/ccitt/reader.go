...
// Vendored from golang.org/x/image@v0.42.0/ccitt (reader.go, table.go)
// so gopdf keeps its no-dependency guarantee. The LICENSE and PATENTS
// files alongside are the originals from that module.
