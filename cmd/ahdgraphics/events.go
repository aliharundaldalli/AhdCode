...
// Canvas.onKey and GUI's Window.onKey. Letters and digits name the physical
// key by its US-layout label, whatever the active keyboard layout, so a
// program that reacts to "A" behaves the same on every keyboard. Keep this
// table identical to cmd/ahdgui/keys.go.
